                ...
                <div class="card card-style login-box">
                    <div class="content">
                        ...
                        <form id="login-form" method="post">
                            <div class="px-2">
                                <div class="user-box" id="phonediv">
                                    <input type="number" id="phone" style="font-size: large;" name="phone" placeholder="" required readonly />
                                    <label for="phone">Phone Number <em style="color:red;">*</em>
                                    </label>
                                </div>
                                <div class="user-box">
