...
<div class="list-group list-custom-small list-menu">
    ...
    <a href="my-jobs">
        <i class="fa fa-book color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
        <span>My Jobs</span>
        <i class="fa fa-angle-right"></i>
    </a>

    <a href="history">
        <i class="fa fa-history color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
        <span>Task History</span>
        <i class="fa fa-angle-right"></i>
    </a>

    <a href="task">
        <i class="fa fa-tasks color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
        <span>Task</span>
        <i class="fa fa-angle-right"></i>
    </a>
