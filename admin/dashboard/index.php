...
// Delete Social Media 
  function deleteMedia(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/custom.php?delete-media",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Delete Media, Please Try Again Later", "error");   }
                });   
              } else {     
  ...
  function deleteApi(id){
    swal({   
              ...
              if (isConfirm){     
                  $.post("includes/route.php?delete-api",{id:id},function(res){
                  ...
                  else{swal("Error!", "Unable To Delete API Provider, Please Try Again Later", "error");   }
                });   
              } else {     
